...
{
	char *arg, *path, *fname, **argv, **environ, **cmd_buf;
	int argc, err_num, linecount_flag, env_changed, status, cmd_buf_type, readfd;
...
#define INFO_INIT \
{NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, \
	NULL, NULL, 0}
